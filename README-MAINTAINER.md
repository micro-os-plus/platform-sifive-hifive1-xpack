...
- name the post like: **µOS++ platform-sifive-hifive1 v1.1.0 released**
...
- `npm dist-tag add @xpack-sifive/platform-hifive1@1.1.0 latest`
- `npm dist-tag ls @@xpack-sifive/platform-hifive1`
...
- paste the release name like **µOS++ platform-sifive-hifive1 v1.1.0 released**
